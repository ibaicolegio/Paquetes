function calcular(){
    ...
    if(cantBarrasPaquete1<cantBarra){
        ...
        cantBarrasPaquete2=Math.floor(cantBarra-cantBarrasPaquete1*cantPaquete1);
        ...
        if(cantBarrasPaquete2!=cantBarrasPaquete1){
            ...
            document.getElementById("aBarras").innerHTML="de "+cantBarrasPaquete2+" barras";
            document.getElementById("cPesoPorPaquete").innerHTML=pesoPaquete2+" KG de peso";
            document.getElementById("bPaquetes").innerHTML=cantPaquete2+" paquetes";
    
            document.getElementById("solucion2").style.display="inline-block";
        } else {
            cantPaquete1++;
        }
    } else {
    ...
    document.getElementById("xBarras").innerHTML="de "+cantBarrasPaquete1+" barras";
    document.getElementById("zPesoPorPaquete").innerHTML=pesoPaquete1+" KG de peso";
    document.getElementById("yPaquetes").innerHTML=cantPaquete1+" paquetes";

    document.getElementById("solucion1").style.display="inline-block";
}